    ...
    <div className="my-[5rem] px-2">
      ...
      <div className="lg:w-[85vw] mx-auto mt-4 ">
        <Swiper
          ...
          className="mySwiper shadow-md rounded-lg hover:bg-red-50 duration-500"
        >
          {feedbacks?.map((feedback) => (
            <SwiperSlide key={feedback.id}>
              <div className="p-5 md:p-14 lg:px-20 lg:py-12 group  ">
                <div className="flex items-start justify-start gap-3 group-hover:gap-5 duration-500 ">
                ...
                <p className="mt-4 text-sm text-gray-600">{feedback?.date} </p>
