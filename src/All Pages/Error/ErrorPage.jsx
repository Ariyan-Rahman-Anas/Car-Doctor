...
const ErrorPage = () => {
    return (
        ...
        <div className="h-[100vh] text-center flex flex-col gap-5 ">
            ...
            <Link to={"/"} className="text-white bg-[#ff3811] px-4 py-2 w-fit mx-auto rounded-md hover:text-[#ff3811] hover:bg-white border-[.09rem] border-[#ff3811] duration-500 ">Go Back to the Home Page</Link>
        </div>
    );
};
